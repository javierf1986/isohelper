...
# Import Base from all model files to get all table metadata
...
from backend.models.artifact_models import (
    ...
    ManagementReview, TrainingRecord, CustomerComplaint, QualityObjective, RequirementsReview, QualityPolicy
)
...
from backend.models.gap_models import GapAnalysis, Gap, ComplianceEvidence, RoadmapItem
...
# All models imported above share the same Base.metadata
