      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium text-blue-900 mb-1">Dashboard Under Development</h4>
              <p className="text-sm text-blue-800">
                Full document generation, export functionality, and compliance tracking features are coming soon.
                Authentication and core API integration are now complete!
              </p>
            </div>
          </div>
        </div>
